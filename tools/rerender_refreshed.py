# -*- coding: utf-8 -*-
"""对一批「数据已刷新到最新」的题材，重渲染成片并覆盖回原编号文件。
串行、失败隔离、单题材重试一次。后台运行。
"""
...
# (key, registry_file)
JOBS = [
    ('coal_production', 'topics_registry_owid_b.json'),
    ('gas_production', 'topics_registry_owid_b.json'),
    ('cpi', 'topics_registry_cpi.json'),
    ('m2_gdp', 'topics_registry_batch3.json'),
    ('trade_gdp', 'topics_registry_wb.json'),
    ('national_pop', 'topics_registry_batch2.json'),
]
